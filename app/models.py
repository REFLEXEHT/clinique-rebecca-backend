...
class User(Base):
    ...
    role            = Column(String(30), default=RoleEnum.patient.value)
    telephone       = Column(String(50))
    specialite      = Column(String(255))
    type_medecin    = Column(String(20), nullable=True)
...
class RendezVous(Base):
    ...
    type_rdv           = Column(String(20), default=TypeRDVEnum.presentiel.value)
    statut               = Column(String(50), default=StatutRDVEnum.en_attente.value)
